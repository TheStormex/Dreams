...
function initialisation() {
  ...
  screws = new Player("Screws", 200, 5, 20, [[ab_targetExploits, ab_energyRecharge, ab_ult_hexcodeDeflector], [ab_magnetize, ab_shockwave, ab_ult_explosion]], pro_p_bolt_basic, screwsImages);
